    ...
    <form class="crete-form" enctype="multipart/form-data" action="{{route('admin.employees.update', ['employee'=>$employee->id])}}" method="POST">
        ...
        <div class="form-group">
            <div class="mb-5">
                ...
                <img id="frame" class="img-fluid mb-2 center-cropped" src="{{$employee->photo_url ?? 'https://dummyimage.com/300x300/272d31/fff.png&text=Photo+placeholder'}}"/>
        ...
        <div class="form-group">
            ...
            <small id="nameDescription" class="form-text text-muted justify-content-end text-right">
                {{strlen(old('full_name') ?? $employee->full_name)}}/256
            </small>
        </div>
